...
class Simple extends IController
{
	...
	public function seller_reg()
	{
		...
		$url="http://api.map.baidu.com/geocoder/v2/?address=$address&output=json&ak=TptMGLlGpKxfx9WKY07SKOGN13ckI2FX&callback=showLocation";
		$ch=curl_init();
		curl_setopt($ch, CURLOPT_URL, $url);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
		$str=curl_exec($ch);
		//echo $str;
		//showLocation&&showLocation({"status":0,"result":{"location":{"lng":118.77006979986358,"lat":32.083556245357147},"precise":1,"confidence":80,"comprehension":100,"level":"购物"}})
		$left=strpos($str, '(');
		$right=stripos($str,')');
